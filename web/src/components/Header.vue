...
<template>
  <header id="header" class="px-[5%] h-20 text-white bg-blue-500 flex flex-row space-x-12 text-center items-center">
    <img alt="logo" class="h-12 w-12" src="/vite.svg"/>
    <span class="text-2xl">Alibaba Cluster Trace Program</span>
